...
function Home() {
  ...
  const advantages = [
    ...
    },
    {
      ...
      description:
        'RentVerse handles all property management aspects, from maintenance to tenant relations.',
    },
  ];
      ...
      questions: [
        {
          ...
          answer:
            'RentVerse is an innovative investment project dedicated to real estate. We allow clients to invest as little as $10 in investment properties, with the aim of building up regular income and/or savings.',
        },
        {
        ...
        },
        {
          ...
          answer:
            'RentVerse uses the most advanced technical means to ensure the confidentiality and security of transactions on the platform. ',
        },
      ],
    },
  ];
  ...
  return (
    <div className="space-y-16">
      ...
      <section className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {investmentSteps.map((step, index) => (
            ...
            >
              <div className="bg-white dark:bg-secondary-900 p-6 rounded-lg shadow-md text-center border dark:border-secondary-800">
                <div className="bg-primary-50 dark:bg-secondary-800 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
      ...
      {/* Why Choose Us */}
      <section className="bg-secondary-50 dark:bg-secondary-900/40 dark:border-secondary-800 border-y py-16">
        <div className="container">
          <div className="text-center mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {advantages.map((advantage, index) => (
              <motion.div
                key={index}
                className="bg-white border dark:border-secondary-800 dark:bg-secondary-900 p-6 rounded-xl shadow-md text-center"
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                transition={{ delay: index * 0.2 }}
      ...
      {/* Blog */}
      <div className="container bg-white dark:bg-secondary-900/50 border dark:border-secondary-800 rounded-2xl px-8 py-20">
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {blogPosts.map((post, index) => (
            <motion.article
              ...
              className="bg-white rounded-xl dark:bg-secondary-900 dark:border-secondary-800 border shadow-md overflow-hidden"
            >
              <Link to={`/blog/${post.slug}`}>
                <div className="relative h-48">
                  <img src={post.image} alt={post.title} className="w-full h-full object-cover" />
                  <div className="absolute top-4 right-4 bg-white  dark:bg-secondary-800/70 border dark:border-secondary-700 dark:text-primary-400 px-3 py-1 rounded-full text-sm font-medium text-primary-600">
      ...
      <section className="container">
        ...
        >
          <div className="text-center mb-12">
            ...
            <p className="text-secondary-600 dark:text-secondary-400">
              Find answers to common questions about our platform, cryptocurrency payments, and real
              estate investment.
            </p>
          </div>
          ...
          <div className="lg:grid lg:grid-cols-2 lg:gap-8 items-center">
            ...
            <div className="mt-12 lg:mt-0 flex justify-center">
              <div className="bg-white rounded-lg shadow-xl p-8 max-w-sm w-full">
                <h3 className="text-2xl font-bold text-gray-900 text-center mb-6">Join Discord</h3>
