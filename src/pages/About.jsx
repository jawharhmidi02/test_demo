...
function About() {
  ...
  return (
    <div className="min-h-screen bg-secondary-50 dark:bg-secondary-950">
      {/* Hero Section */}
      <section className="relative bg-secondary-900 dark:bg-secondary-900/50 border-b dark:border-secondary-800 text-white py-24">
        <div className="container">
          ...
          >
            ...
            <p className="text-xl text-secondary-200">
              We're bridging the gap between traditional real estate and cryptocurrency, making
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              <motion.div
                ...
                className="bg-white dark:bg-secondary-900 border dark:border-secondary-800 rounded-lg p-6 text-center shadow-md"
              >
      ...
      {/* Mission Section */}
      <section className="py-16 bg-white dark:bg-secondary-900 border dark:border-secondary-800">
        <div className="container">
          <div className="max-w-3xl mx-auto text-center mb-16">
            <h2 className="text-3xl font-bold mb-6">Our Mission</h2>
            <p className="text-lg text-secondary-600 dark:text-secondary-400">
              To democratize real estate investment by leveraging blockchain technology, making
              property ownership accessible to investors worldwide through fractional ownership and
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              <div className="bg-primary-50 dark:bg-secondary-800 border dark:border-secondary-700 p-4 rounded-full w-20 h-20 flex items-center justify-center mx-auto mb-4">
                <FaHandshake className="w-8 h-8 text-primary-600" />
              </div>
              <h3 className="text-xl font-semibold mb-4">Accessibility</h3>
              <p className="text-secondary-600 dark:text-secondary-400">
                Making real estate investment available to everyone through fractional ownership and
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-3xl mx-auto">
            <motion.div
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="bg-white dark:bg-secondary-900 border dark:border-secondary-800 p-6 rounded-lg shadow-md text-center"
            >
